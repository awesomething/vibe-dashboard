  ...
  return (
    <div style={{ borderBottom: `1px solid ${COLORS.border}` }}>
      <button onClick={onClick} className="w-full flex items-center justify-between py-5 text-left">
        <span style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 600, color: COLORS.ink, fontSize: "1.1rem" }} className="pr-4">
          {item.q}
        </span>
      ...
      {isOpen && (
        <p style={{ fontFamily: "'Manrope', sans-serif", color: COLORS.inkSoft, fontSize: "0.92rem", lineHeight: 1.65 }} className="pb-5 pr-8">
          {item.a}
        </p>
      )}
    </div>
...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="w-full scroll-mt-20" style={{ backgroundColor: "#fff" }}>
